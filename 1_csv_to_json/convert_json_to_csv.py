...
output_csv = "1_csv_to_json/data_from_json.csv"  # ชื่อไฟล์ CSV สุดท้าย
...
with open(output_csv, 'w', newline='', encoding='utf-8') as csvfile:
    ...
    # เขียนหัวตาราง
    header = ["Year", "File Name", "Date Delivered", "Bibrecord City", "Bibrecord Country", "Bibrecord Organization", "Faculty", "Language", "Database", "Citation Title"]
